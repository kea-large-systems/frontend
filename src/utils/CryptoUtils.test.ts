...
describe("checks if the encrypting utilities work as expected", () => {
 test("checks that the an object can be encrypted and properly returned as an encrypted string", () => {
   ...
   const expectedEncryption = "U2FsdGVkX1+bHDW5IC9gC8T2y7uDG9+Jni8yX8RGh6+sQ439ustGbPoWNT/mNqKW";
  ...
  test("checks that the an object can be encrypted and properly returned as an encrypted string", () => {
    const testUserDetailsEncryption = "U2FsdGVkX1+bHDW5IC9gC8T2y7uDG9+Jni8yX8RGh6+sQ439ustGbPoWNT/mNqKW";
